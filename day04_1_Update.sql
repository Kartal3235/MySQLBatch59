...
update urunler set urun_isim='Telefon' where urun_isim='Iphone';
...
update urunler set urun_ismi=(select firma_ismi from tedarikciler where irtibat_ismi='Adam Eve') 
where musteri_isim='Ali Bak';

-- select firma_ismi from tedarikciler where irtibat_ismi='Adam Eve';//Apple bu sorgu ile alındı//
