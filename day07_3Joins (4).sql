...
from bolumler as B LEFT join personel as P-- sorunun içeriğine göre left veya right karar veriyoruz
on B.bolum_id = P.bolum_id                -- burda anahtar cümle bölümler olduğundan left yaptık  
...
-- P: personel tablo
-- B: bolumler tablo
select personel_isim,bolum_isim,maas from bolumler as B left join personel as P
on B.bolum_id=P.bolum_id
